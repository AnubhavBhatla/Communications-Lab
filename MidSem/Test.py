...
class Test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.hilbert_fc_0_0 = filter.hilbert_fc(6500, window.WIN_HAMMING, 6.76)
        ...
        self.connect((self.blocks_complex_to_imag_0, 0), (self.qtgui_freq_sink_x_1_1_0, 0))
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_freq_sink_x_1_1, 0))
        ...
        self.connect((self.hilbert_fc_0_0, 0), (self.blocks_complex_to_real_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 22000, 4000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 22000, 4000, window.WIN_HAMMING, 6.76))
