...
class MidSem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/abhi/Documents/EE340/MidSem/Double_SSB.dat', True, 0, 0)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, 1.57079+0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0+0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_add_xx_0_2, 1))
        self.connect((self.blocks_add_xx_0_0, 0), (self.qtgui_freq_sink_x_1_1, 0))
        self.connect((self.blocks_add_xx_0_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.blocks_add_xx_0_1, 0), (self.blocks_add_xx_0_0, 1))
        self.connect((self.blocks_add_xx_0_2, 0), (self.rational_resampler_xxx_0_0, 0))
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_sub_xx_0, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_sub_xx_0_0, 0))
        self.connect((self.blocks_complex_to_float_0_0, 1), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_complex_to_float_0_0, 0), (self.blocks_add_xx_0_1, 1))
        self.connect((self.blocks_complex_to_float_0_0, 1), (self.blocks_sub_xx_0, 1))
        self.connect((self.blocks_complex_to_float_0_0, 0), (self.blocks_sub_xx_0_0, 1))
        ...
        self.connect((self.blocks_sub_xx_0_0, 0), (self.blocks_add_xx_0_2, 0))
        self.connect((self.hilbert_fc_0, 0), (self.blocks_complex_to_float_0_0, 0))
        self.connect((self.hilbert_fc_0_0, 0), (self.blocks_complex_to_float_0, 0))
        ...
        self.connect((self.low_pass_filter_1, 0), (self.hilbert_fc_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 22000, 2000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 22000, 2000, window.WIN_HAMMING, 6.76))
