...
class Lab4_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_2 = qtgui.time_sink_f(
            1024, #size
            44100, #samp_rate
            "Demodulated with Emphasis", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.tab_layout_1.addWidget(self._qtgui_time_sink_x_2_win)
        ...
        self.iir_filter_xxx_0 = filter.iir_filter_ffd([1/48000], [1, 1], True)
        self.fir_filter_xxx_0 = filter.fir_filter_ccf(1, [960000,  -960000])
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(1/(2*3.14*75000))
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.blocks_add_xx_1 = blocks.add_vcc(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(-2*3.14*100000)
        self.analog_sig_source_x_2 = analog.sig_source_c(960000, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(75000*2*3.14)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.fir_filter_xxx_0, 0))
        ...
        self.connect((self.iir_filter_xxx_1_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.iir_filter_xxx_1_0, 0), (self.qtgui_time_sink_x_2, 0))
