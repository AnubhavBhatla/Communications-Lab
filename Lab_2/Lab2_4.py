...
class Lab2_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/abhi/Documents/EE340/Lab_2/vocal.wav', True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, 960000,True)
        self.blocks_multiply_xx_2_1_0 = blocks.multiply_vff(1)
        ...
        self.analog_sig_source_x_1_1 = analog.sig_source_f(960000, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_1_0_0 = analog.sig_source_f(960000, analog.GR_COS_WAVE, 200000, 1, 0, 1.5707963267948966)
        self.analog_sig_source_x_1_0 = analog.sig_source_f(960000, analog.GR_COS_WAVE, 200000, 1, 0, 1.5707963267948966)
        self.analog_sig_source_x_1 = analog.sig_source_f(960000, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_multiply_xx_2_0, 2))
        ...
        self.connect((self.analog_sig_source_x_1_0_0, 0), (self.blocks_multiply_xx_2_1_0, 0))
        self.connect((self.analog_sig_source_x_1_1, 0), (self.blocks_multiply_xx_2_1, 1))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_multiply_xx_2, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_multiply_xx_2_0, 1))
        ...
        self.connect((self.blocks_multiply_xx_2_1, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_multiply_xx_2_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_multiply_xx_2_1_0, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.blocks_multiply_xx_2_1_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_2_1, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_2_1_0, 1))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_0_1_0, 0))
