...
class hilbert(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "hilbert")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(960000, analog.GR_COS_WAVE, 100000, 1, 0, 1.5707963267948966)
        self.analog_sig_source_x_0 = analog.sig_source_f(960000, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_complex_to_imag_0, 0), (self.rational_resampler_xxx_0_0, 0))
        ...
        self.connect((self.hilbert_fc_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.qtgui_freq_sink_x_0_0_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0_0_0.set_frequency_range(0, 20*self.samp_rate)
        self.qtgui_freq_sink_x_0_0_0_0_0.set_frequency_range(0, 20*self.samp_rate)




def main(top_block_cls=hilbert, options=None):
