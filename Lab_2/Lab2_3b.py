...
class Lab2_3b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab2_3b")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/abhi/Documents/EE340/Lab_2/data1.dat', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.audio_sink_1 = audio.sink(44100, '', True)
        self.audio_sink_0 = audio.sink(44100, '', True)
        self.analog_sig_source_x_1_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_1_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, 1.5707963267948966)
        ...
        self.connect((self.blocks_file_source_0, 0), (self.blocks_multiply_xx_2_1, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_multiply_xx_2_1_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 22000, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 22000, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Lab2_3b, options=None):
