...
class Lab10_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab10_1")
        ...
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_sink_x_0_0_0_0_0, 0))
...
def main(top_block_cls=Lab10_1, options=None):
