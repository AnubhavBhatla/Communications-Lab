...
class Lab8_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab8_3")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'input.txt', False, 0, 0)
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.qtgui_sink_x_1_0, 0))
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(1, self.symb_rate*self.sps, self.symb_rate, self.alpha, 11*self.sps))
...
def main(top_block_cls=Lab8_3, options=None):
