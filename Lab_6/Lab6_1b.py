...
class Lab6_1b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab6_1b")
        ...
        # Blocks
        ##################################################
        self._gain_range = Range(0, 0.03, 0.00001, 0.00001, 200)
...
def main(top_block_cls=Lab6_1b, options=None):
