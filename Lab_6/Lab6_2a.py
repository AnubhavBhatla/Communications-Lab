...
class Lab6_2a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab6_2a")
        ...
        # Blocks
        ##################################################
        self._gain_range = Range(0.01, 1, 0.01, 0.01, 200)
        ...
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_ff(0.001)
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(20)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/abhi/Documents/EE340/Lab_6/Input.bin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1200000, gain, 0, 0)
...
def main(top_block_cls=Lab6_2a, options=None):
