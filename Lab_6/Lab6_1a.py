...
class Lab6_1a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab6_1a")
        ...
        self.gain = gain = 0.00001

        ##################################################
        # Blocks
        ##################################################
        self._gain_range = Range(0, 0.01, 0.00001, 0.00001, 200)
        ...
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_ff(gain)
        ...
        self.connect((self.blocks_divide_xx_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=Lab6_1a, options=None):
