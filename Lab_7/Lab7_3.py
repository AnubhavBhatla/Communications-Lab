...
class Lab7_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab7_3")
        ...
        self.connect((self.root_raised_cosine_filter_0, 0), (self.qtgui_sink_x_0_0, 0))
...
def main(top_block_cls=Lab7_3, options=None):
