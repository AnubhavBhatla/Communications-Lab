...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(3, [1])
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_if((-1, 1), 1)
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.symb_rate*self.sps, self.symb_rate, 1, 11*self.sps))
