...
class Lab1_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_4")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/abhi/Documents/EE340/Lab_1/shor.wav', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 20, 800, 50, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Lab1_4, options=None):
