...
class Lab9_6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rx_taps = rx_taps = firdes.root_raised_cosine(500,nfilts*sps*symb_rate,symb_rate,alpha,ntaps)
        self.noise = noise = 0
        self.gain = gain = 10
        ...
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(4, 1.4142, 0.0001, 1)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_ic(((1-1j), (1+1j), (-1+1j), (-1-1j)), 1)
        self._cma_range = Range(0.01, 1, 0.01, 1, 200)
        self._cma_win = RangeWidget(self._cma_range, self.set_cma, "'cma'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.digital_cma_equalizer_cc_0, 0), (self.qtgui_sink_x_0_0_0_0_0, 0))
    ...
    def set_sps(self, sps):
        ...
        self.set_rx_taps(firdes.root_raised_cosine(500,self.nfilts*self.sps*self.symb_rate,self.symb_rate,self.alpha,self.ntaps))
